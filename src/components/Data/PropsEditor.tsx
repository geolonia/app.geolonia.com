    ...
    if ("number" === styleSpec[key].type) {
      ...
      input = (
        <select
          ...
          onChange={updatePropSelectHandler}
        >
      ...
      input = (
        <IconSelector
          name={name}
          Icon={value.toString()}
          updateIconHandler={updateIconHandler}
        />
      );
